...
public class CopyCommand extends SubCommand {
    public CopyCommand(PosableArmorStands plugin, CommandManager commandManager) {
    ...
    public String description(Player player) {
        return  ConfigurationManager.getInstance().getLanguageValue(player, LanguageLookup.Commands_Copy_Description);
    }

    @Override
    public String usage(Player player) {
        return ConfigurationManager.getInstance().getLanguageValue(player, LanguageLookup.Commands_Copy_Usage);
    }
    ...
    public void Execute(Player player, String[] args) {
        ArmorStandManager.getInstance().copyArmorStand(player);
    }
}
