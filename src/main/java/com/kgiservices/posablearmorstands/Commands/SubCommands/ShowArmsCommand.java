...
public class ShowArmsCommand extends SubCommand {
    public ShowArmsCommand(PosableArmorStands plugin, CommandManager commandManager) {
    ...
    public String description(Player player) {
        return ConfigurationManager.getInstance().getLanguageValue(player, LanguageLookup.Commands_ShowArms_Description);
    }

    @Override
    public String usage(Player player) {
        return ConfigurationManager.getInstance().getLanguageValue(player, LanguageLookup.Commands_ShowArms_Usage);
    }
    ...
    public void Execute(Player player, String[] args) {
        ...
        ArmorStandManager.getInstance().setArmsVisibility(player, visible);
    }
}
