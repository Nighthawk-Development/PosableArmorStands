...
public class CreateCommand extends SubCommand {
    public CreateCommand(PosableArmorStands plugin, CommandManager commandManager) {
    ...
    public String description(Player player) {
        return ConfigurationManager.getInstance().getLanguageValue(player, LanguageLookup.Commands_Create_Description);
    }

    @Override
    public String usage(Player player) {
        return ConfigurationManager.getInstance().getLanguageValue(player, LanguageLookup.Commands_Create_Usage);
    }
