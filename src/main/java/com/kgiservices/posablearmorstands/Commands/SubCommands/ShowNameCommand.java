...
public class ShowNameCommand extends SubCommand {
    public ShowNameCommand(PosableArmorStands plugin, CommandManager commandManager) {
        super(plugin, commandManager);
    }

    @Override
    public Commands subCommandName() {
        return Commands.ShowName;
    }
    ...
    public String description(Player player) {
        return ConfigurationManager.getInstance().getLanguageValue(player, LanguageLookup.Commands_ShowName_Description);
    }

    @Override
    public String usage(Player player) {
        return ConfigurationManager.getInstance().getLanguageValue(player, LanguageLookup.Commands_ShowName_Usage);
    }
    ...
    public void Execute(Player player, String[] args) {
        ...
        ArmorStandManager.getInstance().setNameVisibility(player, visible);
    }
}
