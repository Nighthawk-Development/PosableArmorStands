...
public class SelectCommand extends SubCommand {
    public SelectCommand(PosableArmorStands plugin, CommandManager commandManager) {
    ...
    public boolean isValid(Player player, String[] args) {
        return numberOfParameters() == args.length;
    }
    ...
    public String description(Player player) {
        return ConfigurationManager.getInstance().getLanguageValue(player, LanguageLookup.Commands_Select_Description);
    }

    @Override
    public String usage(Player player) {
        return ConfigurationManager.getInstance().getLanguageValue(player, LanguageLookup.Commands_Select_Usage);
    }
    ...
    public void Execute(Player player, String[] args) {
        ArmorStandManager.getInstance().selectArmorStand(player);
    }
}
