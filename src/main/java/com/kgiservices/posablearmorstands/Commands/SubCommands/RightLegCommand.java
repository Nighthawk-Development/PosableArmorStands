...
public class RightLegCommand extends SubCommand {
    public RightLegCommand(PosableArmorStands plugin, CommandManager commandManager) {
    ...
    public String description(Player player) {
        return ConfigurationManager.getInstance().getLanguageValue(player, LanguageLookup.Commands_RightLeg_Description);
    }

    @Override
    public String usage(Player player) {
        return ConfigurationManager.getInstance().getLanguageValue(player, LanguageLookup.Commands_RightLeg_Usage);
    }
