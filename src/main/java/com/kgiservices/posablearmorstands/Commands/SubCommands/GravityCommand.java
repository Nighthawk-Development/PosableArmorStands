...
public class GravityCommand extends SubCommand {
    public GravityCommand(PosableArmorStands plugin, CommandManager commandManager) {
        super(plugin, commandManager);
    }

    @Override
    public Commands subCommandName() {
        return Commands.Gravity;
    }
    ...
    public boolean hasPermission(Player player) {
        return player.hasPermission("posablearmorstands.gravity");
    }

    @Override
    public String description(Player player) {
        return ConfigurationManager.getInstance().getLanguageValue(player, LanguageLookup.Commands_Gravity_Description);
    }

    @Override
    public String usage(Player player) {
        return ConfigurationManager.getInstance().getLanguageValue(player, LanguageLookup.Commands_Gravity_Usage);
    }
    ...
    public void Execute(Player player, String[] args) {
        ...
        ArmorStandManager.getInstance().setAffectedByGravity(player, visible);
    }
}
