...
public class ShowBaseCommand extends SubCommand {
    public ShowBaseCommand(PosableArmorStands plugin, CommandManager commandManager) {
        super(plugin, commandManager);
    }

    @Override
    public Commands subCommandName() {
        return Commands.ShowBase;
    }
    ...
    public String description(Player player) {
        return ConfigurationManager.getInstance().getLanguageValue(player, LanguageLookup.Commands_ShowBase_Description);
    }

    @Override
    public String usage(Player player) {
        return ConfigurationManager.getInstance().getLanguageValue(player, LanguageLookup.Commands_ShowBase_Usage);
    }
    ...
    public void Execute(Player player, String[] args) {
        ...
        ArmorStandManager.getInstance().setBasePlateVisibility(player, visible);
    }
}
